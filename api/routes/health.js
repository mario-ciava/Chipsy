...
const createHealthRouter = (dependencies) => {
    ...
    const runDiscordHealthCheck = async() => {
        if (typeof healthChecks.discord === "function") {
            return healthChecks.discord()
        }
        return {
    ...
    router.get("/", async(req, res) => {
        ...
        try {
            checks.discord = await runDiscordHealthCheck()
    ...
    router.get("/ready", async(req, res) => {
        try {
            ...
            const discordHealth = await runDiscordHealthCheck()
            const discordReady = Boolean(discordHealth.alive)
