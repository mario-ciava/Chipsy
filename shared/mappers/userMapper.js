...
const mapProfileRecord = (record) => {
    ...
    return {
        ...
        withholdingUpgrade: record.withholding_upgrade,
        rewardAmountUpgrade: record.reward_amount_upgrade,
        rewardTimeUpgrade: record.reward_time_upgrade,
        winProbabilityUpgrade: record.win_probability_upgrade,
