    ...
    overviewSections: [
        {
            ...
            fields: [
                ...
                { key: "nextReward", label: "Next reward", hint: "Auto payout cadence" },
                { key: "playerSince", label: "Player since", hint: "First Chipsy session" }
            ]
        },
        {
            id: "profile-extra",
            ...
            fields: [
                ...
                { key: "handsLost", label: "Hands lost", hint: "Lifetime defeats" },
                { key: "biggestBet", label: "Biggest bet", hint: "Single wager" },
                { key: "biggestWon", label: "Biggest win", hint: "Largest payout" },
                { key: "netWinnings", label: "Net winnings", hint: "Lifetime delta" },
